...
DROP POLICY IF EXISTS "Employees dapat diubah oleh admin/HRD atau diri sendiri" ON public.employees;
...
DROP POLICY IF EXISTS "Employees dapat dihapus oleh admin atau HRD" ON public.employees;
